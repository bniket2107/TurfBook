...
//   const stateCityMap = {
//     Maharashtra: [
//       "Mumbai", "Pune", "Nagpur", "Aurangabad", "Nashik", "Solapur",
//       "Kolhapur", "Jalgaon", "Dhule", "Palghar", "Thane",
//       "Ahamednagar", "Amravati", "Latur", "Satara", "Sangli",
//       "Beed", "Chandrapur", "Yavatmal", "Jalna", "Nanded",
//       "Parbhani", "Dharashiv"
//     ],
...
//     setState(value);
//     setCityOptions(stateCityMap[value] || []);
//     setCity("");
//   };
...
//     if (isLoading) return; // ✅ prevent double clicks while submitting
...
//       discount: discount === "" ? null : Number(discount),                 // ✅ wired to DTO
...
//                         Leave blank to disable tournament slot booking.
//                       </div>
//                     </div>
...
const RegisterOwner = () => {
  ...
  const [tournamentPrice, setTournamentPrice] = useState(""); // optional
  const [discount, setDiscount] = useState("");               // ✅ NEW
  const [advancePaymentPercentage, setAdvancePaymentPercentage] = useState(""); // ✅ NEW
  const [password, setPassword] = useState("");
  const [confirmPassword, setConfirmPassword] = useState("");
  const [turfName, setTurfName] = useState("");
  const [turfImages, setTurfImages] = useState(null);
  ...
  const handleSubmit = async (e) => {
    ...
    const dto = {
      ...
      advancePaymentPercentage: advancePaymentPercentage === "" ? null : Number(advancePaymentPercentage), // ✅ NEW
      tournamentSlotPrice: tournamentPrice === "" ? null : Number(tournamentPrice),
    };
    ...
    try {
      ...
      setTournamentPrice("");
      setDiscount("");
      setAdvancePaymentPercentage(""); // ✅ reset
      setPassword("");
      setConfirmPassword("");
      setTurfName("");
      setTurfImages(null);
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-md-4">
                      ...
                      <div className="form-text">Leave blank if no discount.</div>
                    </div>
                    ...
                    <div className="col-md-4">
                      ...
                      <div className="form-text">Leave blank if no advance payment required.</div>
                    </div>
                  </div>
